...
generate <- function(lattice=TRUE, n, d, k=2, p.edge, s, beta=0.2, seed=0, n.burnin=5000, n.sim=100, keep.every=5,
                     verbose=FALSE){
...
# source("C:/Users/josmi/UFL Dropbox/Joshua Miles/Overleaf/Inference_Ising/Code/mvc.R")
  ...
  X <- array(runif(n*d*n.sim,min=-k,max=k),dim=c(n,d,n.sim))
   ...
   for(r in 1:n.sim){
     ...
     if(verbose) paste0('Gibbs sampling completed for replication r=',r) |> print()
   }
